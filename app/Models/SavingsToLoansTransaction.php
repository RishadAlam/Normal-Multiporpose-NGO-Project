...
class SavingsToLoansTransaction extends Model
{
    use HasFactory;
     ...
     */
    protected $fillable = [
        'from_volume_id', 'from_center_id', 'from_type_id', 'from_client_id', 'from_saving_profile_id', 'from_acc_no', 'from_acc_main_balance', 'from_acc_trans_balance', 'to_volume_id', 'to_center_id', 'to_type_id', 'to_client_id', 'to_loan_profile_id', 'to_acc_no', 'to_acc_main_balance', 'to_acc_trans_balance', 'officer_id', 'amount', 'expression'
    ];

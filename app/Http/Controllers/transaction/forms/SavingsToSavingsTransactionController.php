...
class SavingsToSavingsTransactionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('offices.transaction.forms.SavingstoSavings', compact('volumes', 'types', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validate->fails()) {
            ...
            SavingsToSavingsTransaction::create(
                [
    ...
    public function report(Request $request)
    {
        ...
        $transactions = SavingsToSavingsTransaction::where('status', '2')
        ...
        return view('offices.transaction.reports.SavingstoSavings', compact('transactions', 'officers'));
    }
    ...
    public function approve(Request $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $transactions = SavingsToSavingsTransaction::whereIn('id', $request->id)
                ->get(['id', 'from_saving_profile_id', 'to_saving_profile_id', 'amount']);
            ...
            SavingsToSavingsTransaction::whereIn('id', $request->id)->update(['status' => '1']);
        });
    ...
    {
        $transactions = SavingsToSavingsTransaction::with('from_client_register:id,name')
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validate->fails()) {
            ...
            SavingsToSavingsTransaction::find($id)
                ->update(
                    [
                        'from_acc_main_balance' => $request->formBalance,
                        'from_acc_trans_balance' => $request->transactionformBalance,
    ...
    {
        SavingsToSavingsTransaction::find($id)->delete();

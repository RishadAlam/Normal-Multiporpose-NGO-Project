...
@push('title')
    {{ __('Savings Account Closing Form') }}
@endpush
...
@section('breadcrumb')
    ...
    <a>{{ __('Closing Form') }}</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Savings Account Closing Form') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 mx-auto" style="max-width: 1000px;">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Savings Account Closing Form</b>
            </div>
            <form id="closing_form" method="POST" action="{{ route('closing.Savings.closing') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-form">
                                ...
                                <input id="interest" type="text" class="form-control" placeholder="xxxx" name="interest"
                                    required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="input-form">
                                <label for="closing_balance" class="form-label">Closing Balance <span
                                        class="text-danger">*</span></label>
                                <input id="closing_balance" type="text" class="form-control" placeholder="xxxx"
                                    name="closing_balance" required readonly>

                                <span class="ms-sm-auto mt-1 mt-sm-0 fs-xs text-danger closing_balance_error"></span>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#interest").on('keyup', function() {
                ...
                $("#closing_balance").val(parseInt(balance) + parseInt(interest))
            })

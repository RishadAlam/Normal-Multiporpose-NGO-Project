        ...
        <div class="grid columns-12 gap-6 my-5">
            <div class="g-col-12 g-col-sm-6 g-col-xl-3 intro-y">
                <div class="report-box zoom-in">
                    <a
                        href="{{ Route('centerSummary.activeSavingsAccounts', ['name' => request()->name, 'id' => request()->id]) }}">
            ...
            <div class="g-col-12 g-col-sm-6 g-col-xl-3 intro-y">
                <div class="report-box zoom-in">
                    <a
                        href="{{ Route('centerSummary.deactiveSavingsAccounts', ['name' => request()->name, 'id' => request()->id]) }}">
                        <div class="box p-5 d-flex align-items-center justify-content-between">
                            <div>
            ...
            <div class="g-col-12 g-col-sm-6 g-col-xl-3 intro-y">
                <div class="report-box zoom-in">
                    <a
                        href="{{ Route('centerSummary.activeloanAccounts', ['name' => request()->name, 'id' => request()->id]) }}">
                        <div class="box p-5 d-flex align-items-center justify-content-between">
                            <div>
                                <i data-feather="user-check" class="report-box__icon text-success"></i>
                            </div>
            ...
            <div class="g-col-12 g-col-sm-6 g-col-xl-3 intro-y">
                <div class="report-box zoom-in">
                    <a
                        href="{{ Route('centerSummary.deactiveloanAccounts', ['name' => request()->name, 'id' => request()->id]) }}">
                        <div class="box p-5 d-flex align-items-center justify-content-between">
                            <div>
                                <i data-feather="user-x" class="report-box__icon text-danger"></i>
                            </div>

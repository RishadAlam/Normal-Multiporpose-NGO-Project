...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Pending Collection Report') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 my-5 pb-5 border-0 card-body-dark"
            ...
            <div class="card-header py-5">
                <b class="text-uppercase" style="font-size: 18px;">Pending Savings Collection Report</b>
            </div>
                    ...
                    <table class="table table-hover table-striped table-report">
                        <thead class="bg-theme-1 text-white border-b-0">
                            <tr>
                                ...
                                <th class="border-bottom-0 text-nowrap">Saving Type</th>
                            ...
                            @forelse ($savings as $key => $saving)
                                <tr>
                                    ...
                                    <td class="text-primary text-info cursor-pointer">
                                        <a
                                            href="{{ Route('collectionsReport.pendingCollection.savings.volumes', $saving->id) }}">
        ...
        <!-- Regular Collection table -->
        <div class="card rounded rounded-3 my-5 border-0 pt-5 mx-auto card-body-dark"
            style="background-color: rgba(var(--bs-theme-2-rgb),var(--bs-bg-opacity))">
            <div class="card-header py-5">
                <b class="text-uppercase" style="font-size: 18px;">Regular Loan Collection Report</b>
            </div>
            <div class="card-body p-0">
                <div class="intro-y overflow-x-auto">
                    <table class="table table-hover table-striped table-report">
                        ...
                        <tbody>
                            ...
                            @forelse ($loans as $key => $loan)
                                <tr>
                                    ...
                                    <td class="text-primary text-info cursor-pointer">
                                        <a
                                            href="{{ Route('collectionsReport.pendingCollection.loans.volumes', $loan->id) }}"><i

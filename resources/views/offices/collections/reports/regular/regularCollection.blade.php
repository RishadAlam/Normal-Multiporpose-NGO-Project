...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Regular Collection Report') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 my-5 pb-5 border-0 card-body-dark"
            ...
            <div class="card-header py-5">
                <b class="text-uppercase" style="font-size: 18px;">Regular Savings Collection Report</b>
            </div>
                            ...
                            @forelse ($savings as $key => $saving)
                                <tr>
                                    ...
                                    <td class="text-primary text-info cursor-pointer">
                                        <a
                                            href="{{ Route('collectionsReport.regularCollection.savings.volumes', $saving->id) }}">
                        ...
                        <tbody>
                            ...
                            @forelse ($loans as $key => $loan)
                                <tr>
                                    ...
                                    <td class="text-primary text-info cursor-pointer">
                                        <a
                                            href="{{ Route('collectionsReport.regularCollection.loans.volumes', $loan->id) }}"><i

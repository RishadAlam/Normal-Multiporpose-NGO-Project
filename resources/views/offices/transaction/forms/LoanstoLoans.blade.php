...
@push('title')
    {{ __('Loan Savings To Loan Savings Transaction') }}
@endpush
...
@section('breadcrumb')
    ...
    <a>{{ __('Transaction') }}</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Loan Savings To Loan Savings Transaction') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 mx-auto">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Loan Savings To Loan Savings Transaction</b>
            </div>
            <form id="transaction_form" method="POST"
                action="{{ route('transactionForms.loanSavingstoLoanSavings.store') }}">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="formLoanType" class="form-label">Saving Type <span
...
@section('customJS')
    <script>
        $(document).ready(function() {
            ...
            function accountInfoLoad(prefix) {

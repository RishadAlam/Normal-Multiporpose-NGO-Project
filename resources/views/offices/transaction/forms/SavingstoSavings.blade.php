...
@push('title')
    {{ __('Savings To Savings Transaction') }}
@endpush
...
@section('breadcrumb')
    ...
    <a>{{ __('Transaction') }}</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Savings To Savings Transaction') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 mx-auto">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Savings To Savings Transaction</b>
            </div>
            <form id="transaction_form" method="POST" action="{{ route('transactionForms.SavingstoSavings.store') }}">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function accountsLoad(prefix) {
                ...
                let savingType = $("#" + prefix + "SavingType").val()
                let accounts = $("#" + prefix + "Saving_profile_id")

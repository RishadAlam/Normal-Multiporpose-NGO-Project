...
@push('title')
    {{ __('Savings To Loan Savings Transaction') }}
@endpush
...
@section('breadcrumb')
    ...
    <a>{{ __('Transaction') }}</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Savings To Loan Savings Transaction') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 mx-auto">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Savings To Loan Savings Transaction</b>
            </div>
            <form id="transaction_form" method="POST" action="{{ route('transactionForms.SavingstoLoans.store') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                ...
                                <select id="formSavingType" name="formSavingType"
                                ...
                                <span class="ms-sm-auto mt-1 mt-sm-0 fs-xs text-danger formSavingType_error"></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="formSaving_profile_id" class="form-label">Account No.
                                    <span class="text-danger">*</span></label>
                                <select id="formSaving_profile_id" name="formSaving_profile_id"
                                    data-placeholder="Select your favorite actors" class="select w-full" required>
                                    <option disabled selected>Choose Account...</option>
                                </select>

                                <span class="ms-sm-auto mt-1 mt-sm-0 fs-xs text-danger formSaving_profile_id_error"></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="transactionformBalance" class="form-label">Balance <span
                                        class="text-danger">*</span></label>
                                <input id="transactionformBalance" type="number" class="form-control"
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="toLoanType" class="form-label">Loan Type <span
                                        class="text-danger">*</span></label>
                                <select id="toLoanType" name="toLoanType" data-placeholder="Select your favorite actors"
                                    class="select w-full" required>
                                ...
                                <span class="ms-sm-auto mt-1 mt-sm-0 fs-xs text-danger toLoanType_error"></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="toLoan_profile_id" class="form-label">Account No.
                                    <span class="text-danger">*</span></label>
                                <select id="toLoan_profile_id" name="toLoan_profile_id"
                                    data-placeholder="Select your favorite actors" class="select w-full" required>
                                    <option disabled selected>Choose Account...</option>
                                </select>

                                <span class="ms-sm-auto mt-1 mt-sm-0 fs-xs text-danger toLoan_profile_id_error"></span>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="input-form">
                                <label for="transactiontoBalance" class="form-label">Balance <span
                                        class="text-danger">*</span></label>
                                <input id="transactiontoBalance" type="number" class="form-control" placeholder="xxxx"
                                    name="transactiontoBalance" readonly required>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#formVolume").on('change', function() {
                accountsLoad('form', 'savings')
                centerLoad('form')
            })
            $("#toVolume").on('change', function() {
                accountsLoad('to', 'loans')
                centerLoad('to')
            })
            ...
            $("#formSavingType").on('change', function() {
                accountsLoad('form', 'savings')
            })
            $("#toLoanType").on('change', function() {
                accountsLoad('to', 'loans')
            })
            $("#formSaving_profile_id").on('change', function() {
                accountInfoLoad('form', 'savings')
            })
            $("#toLoan_profile_id").on('change', function() {
                accountInfoLoad('to', 'loans')
            })

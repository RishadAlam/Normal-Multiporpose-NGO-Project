...
@push('title')
    Savings To Loan Savings Transaction Report
@endpush
...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active"> Savings To Loan Savings Transaction Report</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        <div class="row justify-items-center">
            ...
            <div class="col-md-6 justify-content-md-between align-items-md-center d-md-flex">
                <form action="{{ Route('transactionReports.SavingstoLoans') }}" method="get" id="dateRangeForm">
                    @csrf
        ...
        <div class="card rounded rounded-3 my-5 pb-5 border-0 card-body-dark"
            ...
            <div class="card-header py-5">
                <b class="text-uppercase" style="font-size: 18px;">Savings To Loan Savings Transaction Report</b>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".transaction-delete").on('click', function() {
                let id = $(this).data('id')
                let url = "{{ Route('transactionReports.SavingstoLoans.destroy', 'id') }}"
            ...
            $(".transaction-edit").on('click', function() {
                let id = $(this).data('id')
                let url = "{{ Route('transactionReports.SavingstoLoans.edit', 'id') }}"
                url = url.replace('id', id)
            ...
            $("#update_transaction").on("submit", function(e) {
                ...
                let url = "{{ Route('transactionReports.SavingstoLoans.update', 'id') }}"
                url = url.replace('id', id)
            ...
            $(".aprroval_submit").on('click', function(e) {
                ...
                let url = "{{ Route('transactionReports.SavingstoLoans.approve') }}"
                var id = [];

...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Create New Saving Account') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        <div class="card rounded rounded-3">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Create New Saving Account</b>
            </div>
            <form id="saving_registration" class="validation-form" action="{{Route('registration.newSavings.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="input-form">
                                    ...
                                    <select id="volume" name="volume" data-placeholder="Select your favorite actors"
                                        ...
                                        @foreach ($volumes as $volume)
                                            <option {{old('volume') == $volume->id ? 'selected' : ''}} value="{{$volume->id}}">{{$volume->name}}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select id="Officers" name="officers" data-placeholder="Select your favorite actors"
                                        ...
                                        @if(auth()->user()->can('Officer Selection in Account Registration'))
                                            ...
                                            @foreach ($officers as $officer)
                                                <option {{old('officers') == $officer->id ? 'selected' : ''}} value="{{$officer->id}}">{{$officer->name}}</option>
                                            @endforeach
                                        @else
                                ...
                                <div class="input-form">
                                    ...
                                    <select id="savingType" name="savingType" data-placeholder="Select your favorite actors"
                                        ...
                                        @foreach ($types as $type)
                                            <option {{old('savingType') == $type->id ? 'selected' : ''}} value="{{$type->id}}">{{$type->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="deposit" class="form-label">Deposit
                                        <span class="text-danger">*</span></label>
                                    <input id="deposit" type="number" name="deposit" class="form-control" placeholder="xxxx" value="{{old('deposit')}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="startDate" class="form-label">Start date <span
                                            class="text-danger">*</span></label>
                                    <input id="startDate" name="startDate" class="datepicker form-control" data-single-mode="true" value="{{old('startDate')}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="installment" class="form-label">Duration date <span
                                            class="text-danger">*</span></label>
                                    <input id="Duration" name="duration" class="datepicker form-control" data-single-mode="true" value="{{old('duration')}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="installment" class="form-label">Installment
                                        <span class="text-danger">*</span></label>
                                    <input id="installment" type="number" name="installment" class="form-control @error('installment') is-invalid @enderror" placeholder="xxxx" value="{{old('installment')}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <input id="totalWithoutInterest" type="number" name="totalWithoutInterest"
                                        class="form-control" placeholder="xxxx"  value="{{old('totalWithoutInterest')}}" required readonly>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="interest" class="form-label">Interest (%)
                                        <span class="text-danger">*</span></label>
                                    <input id="interest" type="number" name="interest" class="form-control" placeholder="xxxx" value="{{old('interest')}}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="totalWithInterest" class="form-label">Total include Interest
                                        <span class="text-danger">*</span></label>
                                    <input id="totalWithInterest" type="number" name="totalWithInterest" class="form-control" placeholder="xxxx"  value="{{old('totalWithInterest')}}" required readonly>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="husbandName" class="form-label">Husband/father's Name <span
                                            class="text-danger">*</span></label>
                                    <input id="husbandName" type="text" class="form-control" placeholder="Husband/father's Name" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <input id="motherName" type="text" class="form-control" placeholder="Mother's Name" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <input id="nid" type="number" class="form-control" placeholder="xxx-xxxx-xxx" maxlength="20" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <input id="academyQualify" type="text" class="form-control" placeholder="Academy Qualifications" maxlength="20" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                ...
                                <div class="input-form">
                                    ...
                                    <div class="border p-3 rounded-3">
                                        <div class="form-check d-inline-block me-2">
                                            <input id="Islam" class="form-check-input" type="radio"  value="Islam" onclick="javascript: return false;"> 
                                            <label class="form-check-label" for="Islam">Islam</label>
                                        </div>
                                        <div class="form-check d-inline-block me-2 mt-2 mt-sm-0">
                                            <input id="Hindu" class="form-check-input" type="radio"  value="Hindu" onclick="javascript: return false;">
                                            <label class="form-check-label" for="Hindu">Hindu</label>
                                        </div>
                                        <div class="form-check d-inline-block me-2 mt-2 mt-sm-0">
                                            <input id="Buddha" class="form-check-input" type="radio"  value="Buddha" onclick="javascript: return false;"> 
                                            <label class="form-check-label" for="Buddha">Buddha</label>
                                        </div>
                                        <div class="form-check d-inline-block me-2 mt-2 mt-sm-0">
                                            <input id="Christian" class="form-check-input" type="radio" value="Christian" onclick="javascript: return false;"> 
                                ...
                                <div class="input-form">
                                    ...
                                    <div class="border p-3 rounded-3 @error('occupation') is-invalid @enderror">
                                        <div class="form-check me-2 d-inline-block">
                                            ...
                                            value="Business" onclick="javascript: return false;"> 
                                                <label class="form-check-label"
                                                for="Business">Business</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="Jobs" class="form-check-input" type="radio"  value="Jobs" onclick="javascript: return false;"> 
                                            <label class="form-check-label" for="Jobs">Jobs</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="worker" class="form-check-input" type="radio" 
                                                value="worker" onclick="javascript: return false;"> 
                                                <label class="form-check-label" for="worker">Worker</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="Driver" class="form-check-input" type="radio"  value="Driver" onclick="javascript: return false;"> 
                                                <label class="form-check-label" for="Driver">Driver</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="Rickshaw-driver" class="form-check-input" type="radio"  value="Rickshaw-driver" onclick="javascript: return false;"> 
                                            <label class="form-check-label"
                                                for="Rickshaw-driver">Rickshaw Driver</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="housewife" class="form-check-input" type="radio" value="housewife" onclick="javascript: return false;"> 
                                            <label class="form-check-label"
                                                for="housewife">Housewife</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="Others" class="form-check-input" type="radio"  value="Others" onclick="javascript: return false;"> 
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <div class="border p-3 rounded-3 @error('gender') is-invalid @enderror">
                                        <div class="form-check me-2 d-inline-block">
                                            <input id="Male" class="form-check-input" type="radio" value="Male" onclick="javascript: return false;"> 
                                            <label class="form-check-label" for="Male">Male</label>
                                        </div>
                                        <div class="form-check me-2 d-inline-block mt-2 mt-sm-0">
                                            <input id="Female" class="form-check-input" type="radio" value="Female" onclick="javascript: return false;"> 
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    <label for="mobile" class="form-label">Mobile
                                        <span class="text-danger">*</span></label>
                                    <input id="mobile" type="number" class="form-control" placeholder="01xxx-xxxxxxx" maxlength="11" minlength="11" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="input-form">
                                    ...
                                    <div class="w-52">
                                        <div class="border-2 border-dashed shadow-sm border-gray-200 dark-border-dark-5 rounded-2 p-5">
                                            <div class="h-40 position-relative image-fit cursor-pointer zoom-in mx-auto">
                                                <img class="rounded-2" id="preview_client_image" alt="client_image" src="{{asset('storage/placeholder/profile.png')}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            ...
                                            <input id="name_1" type="text" name="name_1" class="form-control" placeholder="Name" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            <label for="dob_1" class="form-label">Date of
                                                Birth <span class="text-danger">*</span></label>
                                            <input id="dob_1" name="dob_1" class="datepicker form-control" data-single-mode="true" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            ...
                                            <input id="segment_1" type="number" name="segment_1" class="form-control" placeholder="%">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            ...
                                            <div class="w-52">
                                                <div class="border-2 border-dashed shadow-sm border-gray-200 dark-border-dark-5 rounded-2 p-5">
                                                    <div class="h-40 position-relative image-fit cursor-pointer zoom-in mx-auto">
                                                        <img class="rounded-2" id="preview_nominee_1_image" alt="nomee_image_1" src="{{asset('storage/placeholder/profile.png')}}">
                                                    </div>
                                                    <div class="mx-auto position-relative mt-5">
                                                        {{-- <button type="button" class="btn btn-primary w-full">Change Logo</button> --}}
                                                        <label for="nomee_image_1" class="btn btn-primary form-control" style="font-size: 24px"><i class='bx bx-camera' ></i></label>
                                                        <input type="file" id="nomee_image_1" name="nomee_image_1" class="w-full h-full top-0 start-0 position-absolute opacity-0 cursor-pointer" onchange="getImagePreview(event, 'preview_nominee_1_image')" accept="image/*">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="nominee_sections">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            <label for="name_2" class="form-label">Name <span class="text-danger">*</span></label>
                                            <input id="name_2" type="text" name="name_2" class="form-control" placeholder="Name">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            <label for="dob_2" class="form-label">Date of
                                                Birth <span class="text-danger">*</span></label>
                                            <input id="dob_2" name="dob_2" class="datepicker form-control" data-single-mode="true">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="input-form">
                                            ...
                                            <div class="w-52">
                                                <div class="border-2 border-dashed shadow-sm border-gray-200 dark-border-dark-5 rounded-2 p-5">
                                                    <div class="h-40 position-relative image-fit cursor-pointer zoom-in mx-auto">
                                                        <img class="rounded-2" id="preview_nominee_2_image" alt="nomee_image_2" src="{{asset('storage/placeholder/profile.png')}}">
                                                    </div>
                                                    <div class="mx-auto position-relative mt-5">
                                                        {{-- <button type="button" class="btn btn-primary w-full">Change Logo</button> --}}
                                                        <label for="nomee_image_2" class="form-control btn btn-primary" style="font-size: 24px"><i class='bx bx-camera' ></i></label>
                                                        <input type="file" id="nomee_image_2" name="nomee_image_2" class="w-full h-full top-0 start-0 position-absolute opacity-0 cursor-pointer" onchange="getImagePreview(event, 'preview_nominee_2_image')" accept="image/*">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function getAccount() {
                ...
                var account = $("#accNo");
                var url = "{{ Route('registration.newSavings.get.account', ['volID' => ':volume', 'centerID' => ':center'])}}";
                        ...
                        success: function(data){
                            ...
                            if(data){
                                $.each(data, function(key, acc){
                                    options[++key] = '<option value="' + acc.acc_no + '">' + acc.acc_no + '</option>'
                                })
                            }else{
            ...
            $("#accNo").on('change', function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $("#dob").val(data.dob)
                        $('input:radio').filter('[value="' + data.religion + '"]').attr('checked', true)
                        $('input:radio').filter('[value="' + data.occupation + '"]').attr('checked', true)
                        $('input:radio').filter('[value="' + data.gender + '"]').attr('checked', true)
                        ...
                        console.log(ConvertStringToHTML(data.Present_address))
                        $("#Present_address").html(ConvertStringToHTML(data.Present_address))
                    ...
                    success: function(data){
                        if(data != ''){
                            ...
                            $.each(data, function(key, value){
                                options[++key] = '<option value="' + value.id + '">' + value.name + '</option>'
                            })
                        }else{
            ...
            // Submit Form
            $('#saving_registration').on('submit', function(e){
                e.preventDefault()

...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a href="{{ Route('withdrawalReports.savings') }}">Regular Savings Withdrawal Report</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    ...
    <div class="g-col-12 mt-3">
        <div class="row justify-items-center">
            ...
            <div class="col-md-6 justify-content-md-between align-items-md-center d-md-flex">
                <form action="{{ Route('withdrawalReports.savings.report', request()->type_id) }}" method="get"
                    id="dateRangeForm">
                    @csrf
            ...
            <div id="update-withdrawal" class="modal fade" tabindex="-1" aria-hidden="true"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form id="update_withdrawal" action="{{ Route('withdrawalReports.savings.report.update') }}"
                            method="POST">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".withdrawal-delete").on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ Route('withdrawalReports.savings.report.delete') }}",
                            type: "DELETE",
                            headers: {
            ...
            $(".withdrawal-edit").on('click', function() {
                ...
                $.ajax({
                    url: "{{ Route('withdrawalReports.savings.report.edit') }}",
                    type: "POST",
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}"
                    },
            ...
            $(".aprroval_submit").on('click', function(e) {
                ...
                let url = "{{ Route('withdrawalReports.savings.report.approve') }}"
                var id = [];

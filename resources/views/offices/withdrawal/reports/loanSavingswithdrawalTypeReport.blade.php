...
@section('breadcrumb')
    ...
    <a>{{ __('Loan Savings') }}</a>
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">Loan Savings Withdrawal Report</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 my-5 pb-5 border-0 card-body-dark"
            ...
            <div class="card-header py-5">
                <b class="text-uppercase" style="font-size: 18px;">Loan Savings Withdrawal Report</b>
            </div>
                            ...
                            @forelse ($loans as $key => $loan)
                                <tr>
                                    ...
                                    <td class="text-primary text-info cursor-pointer">
                                        <a href="{{ Route('withdrawalReports.loanSavings.report', $loan->type->id) }}">

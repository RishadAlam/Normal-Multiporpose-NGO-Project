...
@push('title')
    {{ __('Regular Savings Withdrawal Form') }}
@endpush
...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a class="breadcrumb--active">{{ __('Regular Savings Withdrawal Form') }}</a>
@endsection
    ...
    <div class="g-col-12 mt-3">
        ...
        <div class="card rounded rounded-3 mx-auto" style="max-width: 1000px;">
            <div class="card-header py-5 text-center">
                <b class="text-uppercase" style="font-size: 22px;">Regular Savings Withdrawal Form</b>
            </div>
            <form id="withdrawal_form" method="POST" action="{{ route('withdrawalForm.savingsForm.store') }}">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#saving_profile_id").on('change', function() {
                ...
                let acc_no = $('#acc_no')
                let url = "{{ Route('withdrawalForm.savingsForm.accInfoLoad') }}"
